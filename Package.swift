...
let package = Package(
    name: "AstroFramework",
    // Spelled as strings because the `.v26` cases need PackageDescription 6.2, and raising
    // swift-tools-version that far would also switch every target to the Swift 6 language mode.
    platforms: [
        .macOS("26.0"),
        .iOS("26.0"),
        .watchOS("26.0"),
